...
in
{
  ...
  services.skhd = {
    ...
    skhdConfig = ''
      ...
      shift + ctrl - a : yabai -m window --resize left:-40:0; yabai -m window --resize right:-40:0
      shift + ctrl - r : yabai -m window --resize bottom:0:40; yabai -m window --resize top:0:40
      shift + ctrl - s : yabai -m window --resize top:0:-40; yabai -m window --resize bottom:0:-40
      shift + ctrl - t : yabai -m window --resize right:40:0; yabai -m window --resize left:40:0
      ...
      ctrl + alt - r : yabai -m window --insert south
      ctrl + alt - s : yabai -m window --insert north
      ctrl + alt - t : yabai -m window --insert east
      ...
      alt - q : yabai -m space --toggle padding; yabai -m space --toggle gap

      # toggle window parent zoom
      alt - g : yabai -m window --toggle zoom-parent

      # toggle window fullscreen zoom
      alt - b : yabai -m window --toggle zoom-fullscreen
      ...
      # toggle sticky
      alt - f : yabai -m window --toggle sticky
